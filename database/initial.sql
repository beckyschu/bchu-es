...
/*!50003 CREATE */ /*!50017 DEFINER=`elastic`@`localhost` */ /*!50003 TRIGGER `url_fix_insert` BEFORE INSERT ON `discoveries` FOR EACH ROW BEGIN
       ...
       END */;;
/*!50003 SET SESSION SQL_MODE="" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`elastic`@`localhost` */ /*!50003 TRIGGER `url_fix_update` BEFORE UPDATE ON `discoveries` FOR EACH ROW BEGIN
           IF NEW.picture LIKE 'http%' THEN
               SET NEW.picture = NEW.picture;
           ELSE
               SET NEW.picture = CONCAT('http://', NEW.picture);
